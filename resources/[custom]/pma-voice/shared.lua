...
if GetConvar('voice_useNativeAudio', 'false') == 'true' then
	...
	Cfg.voiceModes = {
		...
		{2.5, "Normal"}, -- Normal speech distance in gta distance units
		{2.5, "Shouting"} -- Shout speech distance in gta distance units
	}
else
	Cfg.voiceModes = {
		{7.5, "Whisper"}, -- Whisper speech distance in gta distance units
		{7.5, "Normal"}, -- Normal speech distance in gta distance units
